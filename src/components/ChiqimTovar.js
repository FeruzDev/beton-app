...
const ChiqimTovar = () => {
    ...
    const getData = () => {
        ...
        axios.post("https://beton.bgsoft.uz/api/?mod=lastchiqim", newData)
            .then(res =>{
    ...
    return (
        <div className="KirimTovar">
            <h1 className="position-relative">Chiqim jurnali
                <button onClick={exitFc} className="exitBtn"><img  src="/img/exitimg.png" alt="exit"/></button>
            </h1>
            <Link to="/exit-product" className="enterBtn">Chiqimni kiritish</Link>
            <h3 className="tovarListTitle">Bugun chiqganlar</h3>
